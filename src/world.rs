...
fn setup_world(
    ...
    for i in 0..64 {
        ...
        let mut add_face = |pos: &mut Vec<[f32; 3]>, norm: &mut Vec<[f32; 3]>, uv: &mut Vec<[f32; 2]>, ind: &mut Vec<u32>, v: &mut u32, corners: [[f32; 3]; 4], normal: [f32; 3]| {
    ...
    commands.insert_resource(VoxelAssets { 
        ...
        block_types: vec![grass, dirt, stone, wood, water, source, drain, sand, bedrock],
        block_names: vec!["Grass".to_string(), "Dirt".to_string(), "Stone".to_string(), "Wood".to_string(), "Water".to_string(), "Water Source".to_string(), "Water Drain".to_string(), "Sand".to_string(), "Bedrock".to_string()],
    });
...
fn update_voxel_map(commands: &mut Commands, voxel_world: &mut VoxelWorld, old_pos: IVec3, new_pos: IVec3, entity: Entity) {
